...
Speaker.obj : Speaker.cpp Speaker.h    Default.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Speaker.obj" "Speaker.cpp" 



CellularRadio.obj : CellularRadio.cpp CellularRadio.h    Default.h Dialer.h Display.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"CellularRadio.obj" "CellularRadio.cpp" 



Button.obj : Button.cpp Button.h    Default.h Dialer.h 
	$(CREATE_OBJ_DIR)
...
Dialer.obj : Dialer.cpp Dialer.h    Default.h Speaker.h Display.h CellularRadio.h 
	$(CREATE_OBJ_DIR)
	$(CPP) $(ConfigurationCPPCompileSwitches)  /Fo"Dialer.obj" "Dialer.cpp" 



Default.obj : Default.cpp Default.h    Speaker.h CellularRadio.h Button.h Display.h Dialer.h 
	$(CREATE_OBJ_DIR)
...
clean:
	@echo Cleanup
	if exist Speaker.obj erase Speaker.obj
	if exist CellularRadio.obj erase CellularRadio.obj
	if exist Button.obj erase Button.obj
	if exist Display.obj erase Display.obj
	if exist Dialer.obj erase Dialer.obj
